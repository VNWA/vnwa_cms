<template>
    <div class="max-h-full mediaPopup bg-white border border-solid border-purple-500 border-t-0">
        <div class="py-2 relative">
            ...
            <div v-if="isModalReaname"
                ...
                <div class="bg-white p-6 rounded shadow-md">
                    ...
                    <input v-model="reanameData.newName" class="border p-2 mb-4 w-full" placeholder="Enter new name" />
                    <div class="flex justify-end">
                    ...
                    <div class="py-2">
                        <ul>
                            <li v-for="(item, index) in keySelected" :key="index" class="flex gap-4">
                                ...
                                <span v-else-if="dataFiles[item].type == 'document'" class="font-bold text-black/80">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <ul class="flex gap-3 items-center">
                                <li>
                                    <button @click="basePath = ''" class="bg-purple-500 text-white px-3 py-1 text-xl">
                                ...
                                <div class="text-sm max-w-full overflow-hidden border-t-2 pt-3 border-black/10">
                                    <ul>
                                        <li class="mb-3 text-wrap max-w-full" v-if="dataDetail.name">
                                            Name :
                                            <input type="text" :value="dataDetail.name" class="w-full" />
                                        </li>
                                        ...
                                        <li class="mb-3 text-wrap max-w-full flex flex-wrap" v-if="dataDetail.path">
                                            Path :
                                            <input type="text" :value="dataDetail.path" class="w-full" />
                                        </li>
...
const insertData = () => {
    if (keySelected.value.length > 0) {
        const data = keySelected.value
            .map((key) => dataFiles.value[key])
