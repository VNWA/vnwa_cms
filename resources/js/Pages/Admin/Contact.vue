<template>
    <div>
        <AppLayout title="Contacts" :isLoading="isPageLoading">
            <template #header>
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <HeaderBreadcrumbs :breadcrumbs="[['Contacts', route('Contact')]]" />
                    </div>
                </div>
...
const loadDataTable = () => {
    ...
    axios.get('/vnwa/contacts/load-data-table').then(response => {
...
const deleteItems = async () => {
    ...
    try {
        ...
        axios.post('/vnwa/contacts/delete', { dataId: dataDelete }).then(response => {
