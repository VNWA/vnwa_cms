<template>
    <div>
        <AppLayout title=" Edit Product" :isLoading="isPageLoading">
            <template #header>
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <HeaderBreadcrumbs :breadcrumbs="[
                            ...
                            ['Edit', route('Ecommerce.Product.Edit', props.product.id)]
                        ]" />
                    </div>
                </div>
            </template>
                ...
                <div class="lg:col-span-8 col-span-12">
                    <div class="bg-white shadow rounded-sm mb-3 p-2">
                        ...
                        <div class="mb-4">
                            ...
                            <Editor id="desc" v-model="form.desc" class="mt-1 block w-full" />
                        </div>
                        <div class="mb-4">
...
const form = ref({
    parentIds: props.product.categoriesId,
    is_show: props.product.is_show,
    ...
    catalogs: props.product.catalogs,
    description: props.product.description,
    tech_info: props.product.tech_info,
    seo_meta: {
        meta_title: props.product.meta_title,
        meta_desc: props.product.meta_desc,
        meta_image: props.product.meta_image,
    }
});
const errors = ref({
    name: '',
...
const submit = (isRollBack = true) => {
    ...
    axios.post('/vnwa/ecommerce/products/update/'+props.product.id, form.value).then(response => {
