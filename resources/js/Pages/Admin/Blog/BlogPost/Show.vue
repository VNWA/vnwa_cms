    ...
    <AppLayout title="Post" :isLoading="isPageLoading">
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <div>
                    <HeaderBreadcrumbs :breadcrumbs="[['Post', route('Blog.Posts')]]" />
                </div>
            </div>
        </template>
                            ...
                            <DataTable :key="reRender" v-model:server-options="serverOptions" :headers="headers"
                                ...
                                <template #item-operation="item">
                                    <div class="flex items-center  gap-5">
                                        <Link :href="route('Blog.Posts.Edit', item.id)" class=" text-xl text-yellow-600">
                                        <icon :icon="['fas', 'edit']" />
                                        </Link>
...
watch([() => serverOptions.value.categories, () => serverOptions.value.tags], () => {
