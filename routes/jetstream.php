...
use App\Http\Controllers\Inertia\CurrentTeamController;
use App\Http\Controllers\Inertia\ApiTokenController;
use App\Http\Controllers\Inertia\CurrentUserController;
use App\Http\Controllers\Inertia\OtherBrowserSessionsController;
use App\Http\Controllers\Inertia\PrivacyPolicyController;
use App\Http\Controllers\Inertia\ProfilePhotoController;
use App\Http\Controllers\Inertia\TeamController;
use App\Http\Controllers\Inertia\TeamMemberController;
use App\Http\Controllers\Inertia\TermsOfServiceController;
...
Route::group(['middleware' => config('jetstream.middleware', ['web'])], function () {
    ...
    Route::group(['prefix' => 'vnwa', 'middleware' => array_values(array_filter([$authMiddleware, $authSessionMiddleware]))], function () {
        // User & Profile...
